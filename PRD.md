...
> _Last revised 2026-05-18. See git history for prior revisions._
...
| Distribution   | Bun-compiled binary + runtime assets in one install dir. **MVP**: curl-installer (primary) + npm `optionalDependencies` (secondary). **V1**: brew formula. |
| Targets        | macOS arm64/x64, Linux arm64/x64. See [ADR 0006](./docs/adr/0006-no-darwin-x64-prebuilt.md) for the darwin-x64 supersession. |
...
_Deferred features (V1, V2) live in [ROADMAP.md](./ROADMAP.md)._
