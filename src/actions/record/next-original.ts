 ...
 * regardless of smart-next mode. When smart-next is on, the active cursor
 * walks signal-weighted order; J / K are the escape hatch back to document
 * order. When smart-next is off, J / K are equivalent to j / k.
 */
